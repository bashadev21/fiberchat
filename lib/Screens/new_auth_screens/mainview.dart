                    ...
                    ? FloatingActionButton(
                        onPressed: () {
                          if (userProvider.currentIndex == 1) {
                            userProvider.controller.animateToPage(0,
                            ...
                            userProvider.controller.animateToPage(2,
                                duration: Duration(milliseconds: 500),
                                curve: Curves.ease);
                          } else if (userProvider.currentIndex == 4) {
                            userProvider.controller.animateToPage(3,
                                duration: Duration(milliseconds: 500),
                                curve: Curves.ease);
                          } else if (userProvider.currentIndex == 5) {
                            userProvider.controller.animateToPage(4,
                                duration: Duration(milliseconds: 500),
                                curve: Curves.ease);
                          }
                        },
                    ...
                    builder: (_, prov, __) => userProvider.currentIndex != 0
                        ? FloatingActionButton(
                                    ...
                                    if (response['status'] == 'SUCCESS') {
                                      ...
                                      if (verificationResponse != null) {
                                        if (verificationResponse['status'] ==
                                            'SUCCESS') {
                                          userProvider.userEmail.dispose();
                                          userProvider.email.dispose();
                                          FocusManager.instance.primaryFocus
                                              ?.unfocus();
                                          userProvider.controller.animateToPage(
                                              3,
                                              duration:
                            ...
                            child: prov.isLoading
                                ...
                                : Icon(userProvider.currentIndex == 5
                                    ? Icons.check
                                    : Icons.arrow_forward),
                          )
                        : SizedBox()),
