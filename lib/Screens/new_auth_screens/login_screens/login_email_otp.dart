...
class LoginEmailOtpWidget extends StatelessWidget {
  LoginEmailOtpWidget({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Column(
            children: [
              Text(
                'Enter OTP sent to your E-mail id',
              ...
              PinPut(
                  ...
                  onChanged: (o) {
                    ...
                    print("otp ==>  ${userProvider.codeverify}");
                  },
