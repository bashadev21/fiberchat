...
import 'package:fiberchat/Screens/status/status_block_contact_screen.dart';
...
class _StatusState extends State<Status> with AutomaticKeepAliveClientMixin {
            ...
            body: RefreshIndicator(
              ...
              child: Padding(
                ...
                child: Consumer<StatusProvider>(
                    builder: (context, statusProvider, _child) =>
                        Stack(
                          children: [
                            Container(
                                                                  ...
                                                                  CircularBorder(
                                                                    ...
                                                                    icon: Padding(
                                                                      ...
                                                                      child: statusProvider
                                                                          .contactsStatus[idx][Dbkeys
                                                                          .statusITEMSLIST][statusProvider
                                                                          .contactsStatus[idx][Dbkeys
                                                                          .statusITEMSLIST]
                                                                          .length -
                                                                          1][Dbkeys
  ...
  showMediaOptions({required BuildContext context,
